...
public class RefreshTokenCommand : IRequest<RefreshedTokensResponse>
{
    ...
    public class RefreshTokenCommandHandler : IRequestHandler<RefreshTokenCommand, RefreshedTokensResponse>
    {
        ...
        {
            MGH.Core.Security.Entities.RefreshToken refreshToken = await _authService.GetRefreshTokenByToken(request.RefreshToken);
            ...
            MGH.Core.Security.Entities.RefreshToken newRefreshToken = await _authService.RotateRefreshToken(
                user: user!,
                refreshToken,
                request.IpAddress
            );
            MGH.Core.Security.Entities.RefreshToken addedRefreshToken = await _authService.AddRefreshToken(newRefreshToken);
